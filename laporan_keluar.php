      ...
      <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
          ...
          <div class="container-fluid">
            ...
            >
              <h2 class="h3 mb-0 text-gray-800 col-md-9">Laporan Barang Keluar</h2>
            ...
            <div class="card shadow mb-4">
              ...
              <div class="card-body">
                <?php
                $barangHabis = mysqli_query($conn, "SELECT * FROM data_stock WHERE qty < 1");
                ...
                <?php
                $barangSedikit = mysqli_query($conn, "SELECT * FROM data_stock WHERE qty < 10 AND qty >
                0");
                while ($fetch = mysqli_fetch_array($barangSedikit)) {
                    $barang = $fetch['nama_barang']; ?>
                ...
                <div class="row mb-4">
                    <div class="col">
                        <form method="post" class="form-inline">
                            ...
                            <button type="submit" name="filterTgl" class="btn btn-info ml-3">
                  ...
                  >
                    ...
                    <tbody>
                      ...
                      if (isset($_POST['filterTgl'])) {
                          ...
                          $dataStock = mysqli_query($conn, "SELECT * FROM data_barang_keluar keluar, data_stock stock WHERE stock.id_barang = keluar.id_barang AND tanggal BETWEEN '$mulai' AND DATE_ADD('$selesai', INTERVAL 1 DAY)");
                      } else {
