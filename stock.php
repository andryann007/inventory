                                ...
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        ...
                                        while ($data = mysqli_fetch_array($dataStock)) {
                                            ...
                                            $jumlahBarang = $data['jumlah_stock'];
                                            ...
                                            <!-- Edit Data Modal -->
                                            <div class="modal fade" id="editStockModal<?= $idBarang ?>" tabindex="-1"
                                                aria-labelledby="addModalLabel" aria-hidden="true">
                                                <div class="modal-dialog modal-dialog-centered">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title" id="addModalLabel">Edit Data Stock
                                                                Barang</h5>
                                                        ...
                                                        <form method="post">
                                                            <div class="modal-body">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="date" name="tglStock" id="tanggalStock"
                                                                        value="<?= $tanggal ?>" class="form-control"
                                                                        required>
                                                                </div>
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="number" name="jumlahBarang"
                                                                        id="jumlahBarang" placeholder="<?= $jumlahBarang ?>"
                                            ...
                                            <div class="modal fade" tabindex="-1" aria-labelledby="deleteModalLabel"
                                                aria-hidden="true" id="deleteStockModal<?= $idBarang; ?>">
                                                <div class="modal-dialog modal-dialog-centered">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title" id="deleteModalLabel">Hapus Stock Barang
                                                                ?
                                                            </h5>
                                                            <button type="button" class="close" data-dismiss="modal"
                                                                aria-label="Close">
                                                        ...
                                                        <form method="post">
                                                            <div class="modal-body text-center">
                                                                Apakah anda yakin ingin menghapus stock <b>
                                                                    <?= $namaBarang ?>
                                                                </b> ?
                                                            </div>
                                                            <input type="hidden" name="idHapus" value="<?= $idBarang; ?>">
        ...
        <div class="modal-content">
            ...
            <form method="post">
                <div class="modal-body">
                    <div class="form-group">
                        <label for="inputTanggal">Tanggal</label>
                        <input type="date" name="tglStock" id="tanggalStock" placeholder="Tanggal" class="form-control"
                            required>
                    </div>

                    <div class="form-group">
                        <label for="inputNamaBarang">Nama Barang</label>
                        <input type="text" name="namaBarang" id="namaBarang" placeholder="Nama" class="form-control"
                            required>
                    </div>
