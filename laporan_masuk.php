      ...
      <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
          ...
          <div class="container-fluid">
            ...
            >
              <h2 class="h3 mb-0 text-gray-800 col-md-9">Laporan Barang Masuk</h2>
                  ...
                  >
                    ...
                    <tbody>
                      ...
                      if (isset($_POST['filterTgl'])) {
                        ...
                        $dataStock = mysqli_query($conn, "SELECT * FROM data_barang_masuk masuk, data_stock stock WHERE stock.id_barang = masuk.id_barang AND tanggal BETWEEN '$mulai' AND DATE_ADD('$selesai', INTERVAL 1 DAY)");
                      } else {
