...
$getData = mysqli_query($conn, "SELECT * FROM data_supplier WHERE id_supplier='$idSupplier'");
$fetchArray = mysqli_fetch_array($getData);
$idSupplier = $fetchArray['id_supplier'];
$namaSupplier = $fetchArray['nama_supplier'];
$telpSupplier = $fetchArray['telp_supplier'];
$alamatSupplier = $fetchArray['alamat_supplier'];
      ...
      <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
          ...
          <div class="container-fluid">
            ...
            >
              <h1 class="h3 mb-0 text-gray-800 col-md-9">Detail Supplier</h1>
              <a
                href="customer.php"
              ...
              <a
                ...
                role="button"
                data-toggle="modal"
                data-target="#editSupplier<?= $idSupplier; ?>"
                      ...
                      <div class="modal-content">
                        ...
                        <form method="post">
                          <div class="modal-body">
                            ...
                            <div class="form-group">
                              <label for="namaSupplier">Nama Lengkap</label>
                              <input
                                type="text"
                                name="namaSupplier"
                                id="namaSupplier"
                            ...
                            <div class="form-group">
                              <label for="telpSupplier">No. Telp</label>
                              <input
                                type="telpSupplier"
                                name="telpSupplier"
                                id="telpSupplier"
            ...
            <div class="card-body">
              <div class="table-responsive table-striped">
                ...
                >
                  ...
                  <tbody>
                    <?php
                    $dataSupplier = mysqli_query($conn, "SELECT * FROM data_supplier WHERE id_supplier !='$idSupplier'");
                    $i = 1;
                    while ($data = mysqli_fetch_array($dataSupplier)) {
                      $idSupplier = $data['id_supplier'];
                      $namaLengkap = $data['nama_supplier'];
                      $alamat = $data['alamat_supplier'];
                      $telp = $data['telp_supplier'];
                      ?>
                                                              <tr>
                                                                <td>
                                                                  <?= $i++; ?>
                                                                ...
                                                                >
                                                                  <a
                                                                    href="detail_supplier.php?id=<?= $idSupplier ?>"
                                                              ...
                                                              <div
                                                                ...
                                                                aria-labelledby="editModalLabel"
                                                                aria-hidden="true"
                                                                id="editSuppliertModal<?= $idSupplier; ?>"
                                                              >
                                                                <div class="modal-dialog modal-dialog-centered">
                                                                  <div class="modal-content">
                                                                    <div class="modal-header">
                                                              ...
                                                              <div
                                                                ...
                                                                aria-hidden="true"
                                                                id="deleteSupplierModal<?= $idSupplier; ?>"
                                                              >
                                                                <div class="modal-dialog modal-dialog-centered">
                                                                  <div class="modal-content">
                                                                    <div class="modal-header">
