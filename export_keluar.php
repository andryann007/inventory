      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            ...
            <a href="barang_keluar.php" class="btn btn-danger btn-sm col-md2" role="button"><i
        ...
        buttons: [
          ...
          },
          {
            ...
            customize: function (doc) {
              /*doc.content.push(
                              { text: ["Owner Toko Sukses"], margin: [400, 550, 20, 20] }
                          );
                          doc.content.push(
                              { text: ["Fendy Jay"], margin: [400, 40, 20, 20] }
                          )*/
            },
          },
          {
